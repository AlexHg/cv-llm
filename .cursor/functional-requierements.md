...
Specs de features: [Open Responses](./specs/open-responses/SPEC.md) (`SPEC-OR-001`), [Interfaz CopilotKit + CV](./specs/copilot-ui/SPEC.md) (`SPEC-UI-001`), [Perfil estructurado](./specs/cv-structured-profile/SPEC.md) (`SPEC-CV-002`), [Hechos temporales](./specs/cv-facts/SPEC.md) (`SPEC-CV-003`), [A2UI y fichas de empresa](./specs/a2ui-company-tools/SPEC.md) (`SPEC-A2UI-001`), [Evaluación](./specs/evaluation/SPEC.md) (`SPEC-EVAL-001`).
...
Puesto desempeñado.
Periodo o duración (calculados en código; el agente no resta fechas).
